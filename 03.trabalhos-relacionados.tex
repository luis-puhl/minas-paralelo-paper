...
\begin{enumerate*}[label={\alph*)}]
    ...
    \item a mudança de representação de \clusters, atualmente hiper-esferas \cite{Costa2019thesis},
    para hiper-cubos tratando \datasets onde as características representadas
    pelas dimensões são completamente independentes;
    \item um modo interativo onde o \cluster é formado, mostrado ao especialista
    que o classifica como inválido (ruído ou não representativo) ou válido, podendo conter
    ...
    um exemplo não pertencente a uma classe, ou seja, marcar o exemplo como não
    ...
    \item na fase \emph{offline} a verificação de sobreposição de \clusters pertencentes a
