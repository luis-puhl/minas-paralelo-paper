...
Os trabalhos relacionados nessa \refsec{alg-nd}, tem em comum, além do algoritmo
base, métricas de avaliação acurácia (\emph{Macro F-Score} e \emph{Macro
...
detecção de intrusão em rede, focado em processar o voluem
