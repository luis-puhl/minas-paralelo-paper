...
\nota{os trabalhos desta SUBSEÇÃO.. Se vc estiver falando dos trabs MINAS-LC e MINAS-BR}
...
Para o modelo de classificação, a ferramenta CATRACA utiliza uma árvore de decisão
\nota{...}
