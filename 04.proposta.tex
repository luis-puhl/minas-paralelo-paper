...
\newcommand{\fog}{\xspace\emph{fog computing}\xspace}
\newcommand{\iot}{\xspace\emph{IoT}\xspace}
\newcommand{\mfog}{\xspace{M-FOG}\xspace}

\nota{Reestruturar:
  remember,
  cenário (iot, fog, stream),
  problema (4.1, ND em fog, terminar com minas e cassales),
  solução (4.2, apresetnação, resumo \mfog, metodologia)
}
