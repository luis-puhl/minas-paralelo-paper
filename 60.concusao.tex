...
observações de uma rede remota para processamento em nuvem (\cloud) pode resultar em latências proibitivas. 
Uma alternativa viável à computação em nuvem neste caso é a computação em névoa
(\fog) que pode disponibilizar recursos computacionais mais próximos
...
no cluster, ou seja, a escalabilidade almejada não foi alcançada.
...
Como trabalhos futuros, espera-se que esta implementação e análise sirva de
