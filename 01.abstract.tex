...
\begin{resumo}
    ...
    \notahelio{a questão de processamento em nuvem vs névoa não está clara}
...
\begin{abstract}
    ...
    in fog computing environments due to the \notahelio{?}\hl{cost of operating such tools
    ...
    %%
    The MINAS algorithm addresses \notahelio{?}\hl{those novelty detection} in data streams
