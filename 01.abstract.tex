...
\imprimiragradecimentos{
   ...
   Professor Hermes e Doutor Guilherme pela experiência compartilhada.
...
%    Sugestão:
   Agradeço também ao CNPq e ao Programa de Pós-Graduação em Ciência da
   Computação da UFSCar pelo apoio recebido
   (contrato 167345/2018-4).
% Obs.: a concessão é co CNPQ para o PPGCC, e este repassa ao aluno, então é bom agradecer a todos.
