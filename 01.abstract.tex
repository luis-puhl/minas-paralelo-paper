...
\begin{resumo}{Detecção de Novidades. Detecção de Intrusão. Fluxos de Dados.
   ...
   computacionais e aos conteúdos transmitidos. Métodos para mineração de dados
   de forma robusta e contínua podem ser um aliado à segurança nesses casos.
   % 
   ...
   beneficiadas por algoritmos de detecção de novidades.
   % 
   ...
   Mesmo em um cenário distribuído, o sistema apresentou eficácia equivalente à
