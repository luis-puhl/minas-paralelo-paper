...
\begin{resumo}
    ...
    \notahl{?}
    \hlhl{somente em ambiente de nuvem}.
    %%
    ...
    novidade em fluxos de dados, \hlfa{como mudança e} evolução de conceito e
    \hlfa{atualização contínua do modelo} de classificação sem interferência de
...
\begin{abstract}
    ...
    in fog computing environments due to the \notahl{?}\hlhl{cost of operating such tools
    ...
    %%
    The MINAS algorithm addresses \notahl{?}\hlhl{those novelty detection} in data streams
