...
\nota{Hélio orientou a ler a intro, pular fundamentos e relacionados e ler a
proposta e conclusão, avaliar se está coerente}
...
de fluxos contínuos e, consequentemente, permite atuar corretamente mesmo
...
Para tratar esse problema, a arquitetura \idsiot recente proposta por
...
dispositivos e avaliando-os quanto a detecção de intrusão.
...
\cite{Faria2016minas} onde o último mostra resultados promissores.
...
multi-processamento ou distribuição computacional que são necessárias para
