...
\textit{Lembre-se:
\textbf{Se 3 palavras formam uma ideia atômica, tenha 2 ligações nas pontas}}
...
\acronym{ND}{Novelty Detection, Detecção de Novidade}
...
% Avaliar = Testes com diferentes data sets (KDD e BigFlow) com as métricas Minas e BigFlow.
...
% Extrair as métricas de detecção de anomalias da implementação com data sets diferentes;
...
% Extrair as métricas de desempenho da implementação com data sets diferentes;
...
Para cumprir os objetivos citados anteriormente, foi identificado a necessidade
...
Além disso, desses trabalhos estrai-se métricas de qualidade de classificação
...
contínuos de dados e técnicas de aprendizado de máquina associadas à elas.
Obtém-se também dessa revisão, as técnicas ou ferramentas necessárias
