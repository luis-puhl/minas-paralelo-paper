...
\todo[inline]{Não sei se vão existir dispositivos SBC na borda para executar. Acho melhor deixar genérico, de que utilizaria quaisquer dispositivos na borda ou na névoa que tenha recursos suficientes para a tarefa. Você usou um SBC para validar a proposta, por este ter arquitetura semelhante à de vários dispositivos que podem estar presentes na borda.}
\begin{figure}[htb]
  \centerline{
...
computacionais e enviados para a nuvem (\cloud) se mais  recursos
