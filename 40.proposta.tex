...
% \begin{resumocap}
  ...
  Este Capítulo apresenta a proposta deste trabalho e a metodologia estabelecida para
...
O design de nossa arquitetura \nd distribuída inclui o particionamento das
funcionalidades de \minas e estabelecendo os fluxos de dados apropriados
...
alguns deles eram recorrentes durante nossas discussões de implementação e são:
