...
\expC, com o número de desconhecidos sofrendo a maior variação, sendo de apenas $129$.
...
sequencial \hlke{dividido} pelo tempo utilizado pela versão paralela.
...
responsável pelo fluxo de saída do \mfog \hlke{.}
...
de novidade, parâmetros do algoritmo e \hlke{estratégias} de paralelismo e
distribuição.
