...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{Implementação sequêncial.}
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \label{fig:lag-mfog}
  \end{subfigure}
  \caption{Visualização de Latência das implementações de referência, sequêncial
...
picos de latência, porém não tão intensos e frequentes na implementação sequêncial
...
executada de maneira distribuída em ambiente de névoa (\fog) é uma estratégia
