...
3 rótulos novidade, $12$ rótulos em \refminas e $9$ em \serial,
...
\serial.
Outro aspecto com relação a rótulos novidade, em \refminas eles surgem mais
...
etapa executada à parte enquanto no \refminas essa etapa já está embutida no
tempo total.
...
\begin{figure}[htb]
  ...
  \begin{minipage}{0.49\textwidth}
    ...
    \caption{Visualização de Latência na Implementação de referência \refminas do algoritmo \minas.}
    \label{fig:lag-java}
  \end{minipage}
  % \hfill
  \vspace{5mm}
