...
% revisar aloritmo: Modelo? Trava? Que tal iniciar essas variáveis nas threads em cujo código elas são utilizadas? Como não são usadas aqui, acho que fica estranho...
