...
\cite{Bonomi2012,Dastjerdi2016,IEEECommunicationsSociety2018}. \todo[inline]{IEEECommunicationsSociety2018 ??  Verificar}
...
\todo[inline]{A figura se refere a alfo específico do M-FOG ou algo geral para MPI? Se for o primeiro caso, seria melhor colocá-la junto ao texto que apresenta o M-FOG. Nesta seção o foco é descrever o MPI.}
...
\todo[inline]{O ultimo paragrafo mistura MPI com a descrição de como foi implementado o M-FOG. Acho que esta seção deveria falar somente do MPI de forma genérica: O que é, para que serve e por que foi escolhido para este trabalho.}