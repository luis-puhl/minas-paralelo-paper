...
Data}, Único Programa, Múltiplos Dados) pode ser implementado utilizando o
...
a comunidade e a indústria padronizaram esse modelo de troca de mensagens no padrão MPI (\emph{Message Passing Interface}, Interface de Troca de Mensagens).
