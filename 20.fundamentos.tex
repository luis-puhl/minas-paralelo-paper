...
O MPI (\emph{Message Passing Interface}, em português Interface de Troca de Mensagens) é um padrão de indústria que estabelece um protocolo 


apesar dele nao processar fluxo de dados, ele dá controle sobre a distribuiçãoe sobre a memoria que sao cruciais para implementacao de dispositivos IoT
...
The
goal of MPI is ambitious; but because the collective effort of collaborative design
and competitive implementation has been successful, it has removed the neegit 
