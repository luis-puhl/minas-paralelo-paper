...
% Não entendi essa questão de filtrar apenas os "normal" class no training set...
...
sendo executadas em combinações de ambientes nuvem e névoa com 
quantidade de nós variada.  % dá-lhe Yoda!
