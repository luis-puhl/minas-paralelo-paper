...
\notahelio{?}\hl{recursos computacionais dimensionados},
...
a \hl{ausência de uma} implementação de algoritmo de detecção de
...
O foco da \notahelio{estão nas referências?}\hl{revisão da literatura acadêmica} é em trabalhos que abordem
