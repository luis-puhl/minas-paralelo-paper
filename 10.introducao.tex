...
% \acronym{IoT}{\emph{Internet of Things}, Internet das Coisas}
...
% \cite{itu}
%  \nota{Cassales não referencia também
...
% \nd, além de classificar em modelos conhecidos, 
% permite classificar novos padrões
...
% \notafa{será que são tradicionalmente implementadas?? acho que não. Eu diria que
% recentemente elas estão indo nesse caminho.}
% são} \hlhl{tradicionalmente implementadas
