...
Contudo, além dos dados de sensores e atuadores que gerenciam, esses dispositivos, se
subvertidos, podem gerar tráfego maligno, como o produzido pela \emph{mirai botnet}
...
redes distantes gerando dados em volumes e velocidades elevadas,
...
de forma que alguns desses trabalhos sirvissem para comparações e relacionamentos.
...
Ao final, a aplicação, resultados, comparações e discussões estão sendo organizados para publicação 
