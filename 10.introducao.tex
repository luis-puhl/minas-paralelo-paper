...
% \notaHS{redes distantes? eu entendi, mas fica estranho dizer dessa forma ... poderia citar a 
% dispersão geográfica ou pervasividade dos dispositivos ... ou seja estão espalhados por
% toda parte ...}
...
% \hlHS{
% redes de dispositivos pervasivos dispersos geograficamente,
% }
...
e, em conjunto com classificadores, podem ser utilizados para detectar padrões
conhecidos.
...
% Given the recent \cite{Viegas2019,Lopez2019,DaCosta2019a} use of Data Stream Novelty
