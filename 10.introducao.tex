...
\todo[inline]{IoT} 
A \iot conecta globalmente variados dispositivos, incluindo diapositivos móveis,
\emph{wearables}, eletrônicos domésticos, automóveis e sensores industriais.
Estes diapositivos podem ser acessados através da Internet ou conectar-se a
outros dispositivos, servidores e aplicações com mínima intervenção ou
supervisão humana
...
outras funções além da função original do dispositivo.
...
subvertidos, podem gerar tráfego maligno, como o gerado pela \emph{botnet} mirai
...
hospedeira, aumentando sua superfície de ataque.
...
limitados à métodos tradicionais de \ml que utilizam modelos estáticos para
...
volumes e velocidades consideráveis, formando fluxos contínuos de dados
(\emph{Data Stream} - DS), técnicas de mineração de fluxos de dados (\emph{Data
Stream Mining}) são amplamente necessárias.
% 
...
\todo[inline]{ND} 
Dentre as técnicas de mineração de fluxo de dados, a \nd 
...
% tratados em outros algoritmos como o MINAS \cite{Faria2015minas}.
...
\citeonline{Cassales2019a}, esta pesquisa escolheu investigar o algoritmo MINAS \cite{Faria2015minas}
