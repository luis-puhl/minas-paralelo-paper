...
simultaneamente num intervalo de avaliação \cite{Faria2016,Gama2010}.
...
descrita por \citeonline{Faria2016}, extraindo dessa matriz duas métricas:
...
\citeonline{Faria2016} foi apresentada com alterações para exemplos multi-rótulo.
